...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 04, 2020 lúc 04:21 PM
...
CREATE TABLE `sach` (
  ...
  `Nhaclaimatkhau` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Tensach` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Giatien` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
